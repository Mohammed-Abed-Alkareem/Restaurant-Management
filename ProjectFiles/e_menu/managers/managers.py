...
@managers.route("change_availibility/<item_id>", methods=['POST'])
...
@managers.route("add_table", methods=['GET', 'POST'])
def add_table():
...
#update menu item
@managers.route("update_menu_item/<item_id>", methods=['GET', 'POST'])
...
@managers.route("add_menu_item", methods=['GET', 'POST'])
def add_menu_item():
    if request.method == 'GET':
